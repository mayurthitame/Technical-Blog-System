...
<nav id="user-nav" class="navbar navbar-expand-lg navbar-dark primary-background">
...
<!--            <li class="nav-item dropdown">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#"><span class="fa fa-address-card"></span>Contact Us</a>
            </li>
            <li class="nav-item">
        ...
        <form class="form-inline my-2 my-lg-0">
            ...
            <a href="admin_login.jsp" class="btn btn-outline-light my-2 my-sm-0"><span class="fa fa-user-circle-o fa-spin"></span>Admin Login</a>
        </form>
    </div>
</nav>
