<%-- 
    ...
    Created on : 13-Sep-2022, 8:49:54 PM
    Author     : mayur
--%>
        ...
        <div class="banner-background">
            <div class="container-fluid p-0 m-0">
                <div class="jumbotron primary-background text-white"> 
                    <div class="container">
                        <h3 class="display-3">Welcome Admin to TechBlog</h3>
                        ...
                        <a href="ad_login_page.jsp" class="btn btn-outline-light btn-lg"><span class="fa fa-user-circle-o fa-spin"></span>Login</a>
                ...
                <div class="col-md-4">
                    <div class="card baseBlock text-center">
                        <div class="card-body">
                            ...
                            <a href="show_blog_admin.jsp?post_id=<%=pp.getPid()%>" class="btn primary-background text-white">Read More</a>
                        </div>
                    </div>
                </div>
                <%
