...
<div class="row">
    <%        PostDao p = new PostDao(ConnectionProvider.getConnection());
        List<Post> list2 = p.getPostByUserId(uid);
    ...
    <div class="col-md-4 text-center">
        <div class="card my-4" style="height: 400px">
            ...
            <div class="card-footer primary-background">
                <a href="show_blog_page.jsp?post_id=<%=pp.getPid()%>" class="btn btn-outline-light primary-background text-white">Read More</a>
